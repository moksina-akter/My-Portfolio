...
const Footer = () => {
  return (
    <motion.footer
      ...
      viewport={{ once: true }}
      className="bg-black/90 text-white pt-16 pb-8 border-t border-gray-800"
    >
      <div className="w-11/12 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div>
          <h1 className="text-3xl font-bold mb-6 bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent inline-block">Moksina Akter</h1>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-6 text-gray-200">Quick Links</h2>
          <ul className="space-y-3">
            {["Home", "About", "Projects", "Services", "Skills", "Blogs", "Contact"].map((item) => (
              <li key={item}>
                <a href={`#${item.toLowerCase()}`} className="text-gray-400 hover:text-purple-400 transition-colors duration-300 flex items-center gap-2 group">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-6 text-gray-200">Contact Us</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-6 text-gray-200">Follow Us</h2>
      ...
      <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
        <p>&copy; {new Date().getFullYear()} Moksina Akter. All rights reserved.</p>
      </div>
    </motion.footer>
  );
};
